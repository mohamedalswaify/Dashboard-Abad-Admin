        ...
        2923: function (t, e, n) {
            ...
            t.exports = function (t, e, n, m, b, y, g) {
                ...
                if (C && (w = l(C.call(new t))) !== Object.prototype && w.next && (u(w, k, !0), r || "function" == typeof w[f] || s(w, f, v)), O && T && T.name !== h && (j = !0, _ = function () {
                    return T.call(this)
                }), r && !g || !p && !j && P[f] || s(P, f, _), a[e] = _, a[k] = v, b)
                    if (x = {
                        values: O ? _ : L(h),
                        keys: y ? _ : L(d),
                        entries: A
        ...
        1181: function (t, e, n) {
            for (var r = n(6997), o = n(7184), i = n(3415), s = n(3816), a = n(7728), c = n(7234), u = n(6314), l = u("iterator"), f = u("toStringTag"), p = c.Array, d = {
                ...
                var m, b = h[v],
                    ...
                    g = s[b],
                    x = g && g.prototype;
                if (x && (x[l] || a(x, l, p), x[f] || a(x, f, b), c[b] = p, y))
            ...
            const c = () => {
                ...
                h = (t, e) => {
                    if ("theme" === t) {
                        ...
                        document.querySelector(".js-stylesheet").setAttribute("href", "~/admin/css/".concat(t, ".css")), a && a !== t && window.location.replace(window.location.pathname), a = t
                    }
